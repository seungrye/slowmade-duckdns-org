...
export default function FortuneToast() {
 ...
 'hover:border-accent-line dark:hover:border-accent-line ' +
 ...
 >
 <div className="grid h-[75px] w-[44px] flex-none place-items-center rounded-md border border-accent-line bg-gray-50 text-accent dark:bg-gray-900 ">
 <span className="text-xl">✦</span>
 </div>
 <div className="min-w-0">
 <div className="text-[11px] font-bold tracking-wide text-accent">오늘의 카드</div>
