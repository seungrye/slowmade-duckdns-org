...
import { applyErosion, crystalsGained, isPetrified, effectiveDamage, bonusDraw } from './stigma';
...
export function draw(state: CombatState, n: number, rng: () => number = Math.random): CombatState {
  let deck = [...state.deck];
