...
| 항목 | 파일 | 상태 |
|---|---|---|
| robots.txt | `webapp/src/app/robots.ts` | 전체 허용 + sitemap 경로 명시 |
| sitemap.xml | `webapp/src/app/sitemap.ts` | 동적 게시물 URL 자동 생성, lastmod/changefreq/priority 포함 |
| 동적 메타데이터 | `webapp/src/app/post/view/[[...id]]/page.tsx` | generateMetadata로 title/description/keywords 설정 |
| 정적 메타데이터 | `webapp/src/app/page.tsx` 등 | 주요 페이지 정적 메타데이터 설정 |
...
**① description 품질이 나쁨**
- 파일: `webapp/src/app/post/view/[[...id]]/page.tsx`
...
- 파일: `webapp/src/app/post/view/[[...id]]/page.tsx` 또는 post-view-container.tsx에 `<script type="application/ld+json">` 추가
