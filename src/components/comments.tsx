...
export default function Comments({ postId }: Props) {
    ...
    return <>
        ...
        <h2 className="text-xl font-semibold mb-2">3 덧글</h2>
        ...
        <div className="space-y-4">
            ...
            <div className="flex items-start gap-4 border border-gray-200 rounded-lg rounded-br-none p-4">
                ...
                <div className="flex-1">
                    <div className="flex items-center gap-2">
                        <h3 className="font-medium text-gray-900 dark:text-white font-mono">{("192.168.0.1")}</h3>
                        <span className="text-sm text-gray-500">·</span>
            ...
            <div className="flex items-start gap-4 border border-gray-200 rounded-lg rounded-br-none p-4">
                ...
                <div className="flex-1">
                    <div className="flex items-center gap-2">
                        <h3 className="font-medium text-gray-900 dark:text-white font-mono">{("101.101.101.101")}</h3>
                        <span className="text-sm text-gray-500">·</span>
