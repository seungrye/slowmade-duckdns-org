      ...
      {isAuthor && (
        <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} title="게시물 삭제 확인">
          ...
          <div className="mt-6 flex justify-end gap-3">
            <button onClick={() => setIsModalOpen(false)} className="px-4 py-2 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 rounded-md hover:bg-gray-300 dark:hover:bg-gray-600 transition" disabled={isDeleting} aria-label="게시물 삭제 취소">취소</button>
